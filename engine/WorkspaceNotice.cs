...
/// <summary>
/// Tells the owner, on their own desktop, that a workspace finished, failed, needs them, or was
/// interrupted. A workspace runs with its panel closed and ARS minimised, so an outcome that
...
/// module never leaves a second permanent icon beside ARS's own in the notification area.
/// </summary>
